...
import { BlockieAvatar } from "@/libs/scaffold-eth/components";
import { useTargetNetwork } from "@/libs/scaffold-eth/hooks/useTargetNetwork";
import { getBlockExplorerAddressLink } from "@/libs/scaffold-eth/utils";
...
export const Address = ({
  ...
  const blockieSize =
    showSkeleton && !onlyEnsOrAddress ? getNextSize(blockieSizeMap, addressSize, 4) : addressSize;
